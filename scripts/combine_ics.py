...
SOURCE_NAMES = {
    ...
    'wake_county_legistar': 'Wake County',
    'chapelhill_legistar': 'Town of Chapel Hill',
    'durhamcounty_legistar': 'Durham County',
    ...
    'songkick_elephant': 'Elephant in the Room (Songkick)',
    'eventbrite_elephant': 'Elephant in the Room (Eventbrite)',
    ...
    'songkick_rancho_nicasio': 'Rancho Nicasio (Songkick)',
    'songkick_big_easy': 'The Big Easy (Songkick)',
    ...
    'eventbrite_phoenix': 'Phoenix Theater (Eventbrite)',
