...
- Outdoor recreation — Eno River Assn: Google Calendar embedded but ID unknown. DNCR covers state parks. Triangle Land Conservancy already implemented.
- Faith / spiritual — No ICS feeds found for Triangle-area faith orgs.
- Seniors — No dedicated senior event ICS feeds found.
...
- Volunteering / mutual aid — Hands On Triangle, Habitat Durham: no ICS feeds.
...
- Chambers of Commerce — Raleigh (Atlas SPA), Cary (Atlas SPA), Chapel Hill (MicroNet): all dead ends. Could look for smaller-town chambers.
- Community centers — Durham Parks & Rec CivicEngage site may have iCal subscription; needs further testing.
