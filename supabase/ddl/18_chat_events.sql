-- Chat-events SQL executor
-- Allows the chat edge function to execute a constrained SELECT against
-- the concierge retrieval surface after validating the query shape.
