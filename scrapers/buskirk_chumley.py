...
class BuskirkChumleyScraper(BaseScraper):
    ...
    def fetch_events(self) -> list[dict[str, Any]]:
        ...
        # NOTE: Do NOT send Accept-Encoding. The site's CDN (SiteGround
        # Optimizer) serves a stripped page — sans div[data-id] .tile
        # elements — when Accept-Encoding: gzip, deflate is present.
        # urllib3 handles transparent decompression regardless.
        headers = {
            "User-Agent": "curl/8.0",
        ...
        # Remove the default Accept-Encoding to avoid stripped-page response
        ...
        tiles = soup.select("div[data-id] .tile")
        if not tiles:
