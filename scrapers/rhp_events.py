...
class RhpEventsScraper(BaseScraper):
    ...
    def __init__(self, rss_url: str, source_name: str, tz: str = "America/New_York",
...
def main():
    ...
    parser.add_argument('--url', required=True, help='RSS feed URL (e.g. https://venue.com/events/feed/)')
    ...
    parser.add_argument('--default-location', default='', help='Fallback location when JSON-LD has none')
